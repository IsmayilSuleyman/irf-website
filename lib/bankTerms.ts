...
// The types and DEFAULT_TERMS fallback live in lib/bankTermsData (client-
// safe); re-exported so server-side imports keep working.

export { DEFAULT_TERMS };
export type { BankProductTerms, ProductTerm };
