...
// Fully static: the public front door prerenders at build time (the
// ?setup=supabase notice reads its param client-side), so the first byte
  ...
  return (
    <main className="min-h-screen overflow-hidden p-1.5 sm:p-2">
      ...
      {/* Two soft washes instead of the old flotilla of glass shapes: one
        ...
        />
        <WelcomeView year={new Date().getFullYear()} />
      </section>
    </main>
  );
}
