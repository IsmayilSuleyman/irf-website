    ...
    <div className="relative z-10 flex min-h-[calc(100vh-0.75rem)] flex-col px-6 py-8 sm:px-10 sm:py-12 lg:px-20 lg:py-16">
      {showSetupNotice ? (
        ...
        >
          ...
          <p className="mt-2 text-sm leading-6 text-black/55 sm:text-[0.98rem]">
      ...
      <motion.div
        {...riseIn(0.06)}
        className="mt-6 max-w-[60rem] rounded-hero bg-[linear-gradient(135deg,rgba(255,255,255,0.62),rgba(255,255,255,0.34))] px-5 py-5 shadow-[0_18px_60px_rgba(106,149,121,0.06)] backdrop-blur-[10px] sm:px-8 sm:py-7 lg:px-10"
      >
        <h1 className="text-[clamp(3.5rem,7.2vw,6.1rem)] font-black leading-[0.92] tracking-[-0.08em] text-ink">
          İsmayıl Maliyyə Xidmətləri
        </h1>
        <p className="mt-5 max-w-[46rem] text-[clamp(1.35rem,2.3vw,2.2rem)] leading-[1.15] tracking-[-0.05em] text-black/45">
      ...
      <motion.p
        {...riseIn(0.22, 16)}
        className="mt-auto pt-10 text-center text-sm tracking-[-0.02em] text-black/30"
      >
